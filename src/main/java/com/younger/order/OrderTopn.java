...
public class OrderTopn {
    ...
    public static class OrderTopnReducer extends Reducer<Text, OrderBean, OrderBean, NullWritable> {
        ...
        protected void reduce(Text key, Iterable<OrderBean> values, Context context) throws IOException, InterruptedException {
            ...
            ArrayList<OrderBean> beadList = new ArrayList<>();
            ...
            for (OrderBean orderBean : values) {
                ...
                beadList.add(newBean);
            }

            //对beanList中的orderBean对象排序，按总金额大小倒序排列，如果总金额相同，则对比商品名称
            Collections.sort(beadList);

            for (int i = 0; i < topn; i++) {
                context.write(beadList.get(i), NullWritable.get());
            }
        }
    }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        FileInputFormat.setInputPaths(job, new Path("F:\\codedata\\mapreducetest3\\orderData"));
        FileOutputFormat.setOutputPath(job, new Path("F:\\codedata\\mapreducetest3\\orderOutput1"));
